    ...
    <div className="relative" ref={wrapperRef}>
      ...
      >
        <div className="flex items-center gap-3">
          <img src={selectedCountry.iconUrl} alt={selectedCountry.label} className="w-6 h-auto shadow-sm rounded-[2px]" />
          <span className="text-sm font-medium" style={{ color: '#fff' }}>{selectedCountry.label}</span>
        </div>
      ...
      {isOpen && (
        <div 
          className="absolute z-50 w-full mt-2 rounded-xl border border-purple-500/30 overflow-hidden flex flex-col"
          style={{ 
